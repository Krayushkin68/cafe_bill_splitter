<template>
    <nav class="navbar navbar-expand-sm navbar-light bg-light shadow-sm">
        <div class="container-fluid">
            ...
            <button ref="closeBtn" class="navbar-toggler" type="button" data-bs-toggle="collapse"
            ...
            <div ref="navContent" class="collapse navbar-collapse" id="navbarText">
                ...
                <button v-if="!isAuthorized" class="btn btn-outline-success me-3" @click="goTo('login')">Войти</button>
                <span v-else class="navbar-text">
        <!-- <span class="me-2">Имя пользователя</span> -->
        <button class="btn btn-outline-danger me-3" @click="LogOut">Выйти</button>
      </span>
            </div>
        </div>
    </nav>
